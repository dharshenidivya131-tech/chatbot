...
# ---------------------------
# MAP MODEL OUTPUT → YOUR RESPONSE KEYS
# ---------------------------
mood_map = {
    "joy": "Happy",
    "sadness": "Sad",
...
# ---------------------------
# RESPONSES (YOUR ORIGINAL STYLE KEPT)
# ---------------------------
responses = {
    "Happy": [
...
def chatbot(message):
    ...
    mood = mood_map.get(raw_mood, "Neutral")   # ✅ SAFE FIX
...
interface = gr.Interface(
    fn=chatbot,
    inputs=gr.Textbox(lines=4, placeholder="How are you feeling?"),
